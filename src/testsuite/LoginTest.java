...
public class LoginTest extends Utility {
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials() {
        ...
        sendTextToElement(By.name("username"), "annawong1");

        //* Enter valid password
        sendTextToElement(By.name("password"), "test321");
    ...
    public void verifyTheErrorMessage() {
        ...
        //verifyText(By.xpath("//h1[contains(text(),'Error!')]"),"Please enter a username and password.");
    }
